...
public class DoingIt {
    private final int NUMBER_OF_RECTANGLES = 81*3 ; //square root must be an integer for uniformRectangles to execute
    ...
    public void yourOperation() {
        ...
        for (int j = 1; j <10; j++){
            ...
            for (int i = 1; i < 10; i++) {
                ...
                int green = 255-(255/i)-(255/j);
                if (green < 0){ green = 0;}
                Rectangle r = new Rectangle(i * 0.1, j*i*0.05, 0.1, 0.1, new Color(255/i,green,255/j), 0.01);
                rectangles[c] = r;
                c++;
            }
        ...
        for(int i = 1; i< 10; i++){
            ...
            for (int j = 1; j < 10; j++){
                int green = 255-(255/i)-(255/j);
                if (green < 0){ green = 0;}
                Rectangle r = new Rectangle(j*0.15,i*0.15,j*0.1,j*0.1,new Color(255/i,green,255/j),0.01);
                rectangles[c] = r;
                c++;
            }
        ...
        for(int i = 1; i< 10; i++){
            ...
            for (int j = 1; j < 10; j++){
                ...
                Rectangle r = new Rectangle(x,y,j*0.1,j*0.1,new Color(255/i,green,255/j),0.01);
                rectangles[c] = r;
                if (j%2 == 0) {
                    y = y - x/2;
