...
//        myWindow.writeOutLine(b);
    ...
    private void lab1(){
        ...
        //a
        int lastElem = myIntegerArray[myIntegerArray.length -1];
        myWindow.writeOutLine("Last element = " + lastElem);

        int[] newArray = {1,2,3,4,5};
        lastElem = newArray[myIntegerArray.length -1];
        myWindow.writeOutLine("Last element = " + lastElem);

        //b
        int prod = a[0] * a[1] *a[2] * a[3];
        myWindow.writeOutLine("Product of all elem = " + prod);

        //c
        boolean result = a[2] == Math.sqrt(a[0]);
        myWindow.writeOutLine("3rd element is square root of 1st element = " + result);
    ...
    private void lab2(){
        ...
        myWindow.writeOutLine(myStringArray[1]);

        boolean test1 = myStringArray[1].contains("Y");
        myStringArray[100] = "john";
        int elemLength = myStringArray[0].length();
        myWindow.writeOutLine("First element length = " + elemLength);
    ...
    private void lab3(){
        ...
        myWindow.writeOutLine("index of seven = " + myList.indexOf("even"));

        //b
        boolean answer =myList.contains("seven");
        myWindow.writeOutLine("List contains seven = " +  answer);

    }

    private void lab4(){
        myWindow.writeOutLine("EX04");
        String myStr = "CAtaStROPhe" ;
        String newStr = myStr.substring(0,1).toUpperCase() + myStr.substring(1).toLowerCase();
        myWindow.writeOutLine( myStr + " converted to " + newStr);

        myStr = "jOhNy";
        newStr = myStr.substring(0,1).toUpperCase() + myStr.substring(1).toLowerCase();
        myWindow.writeOutLine( myStr + " converted to " + newStr);
    }
